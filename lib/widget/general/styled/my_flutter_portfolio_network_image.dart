...
import 'package:my_flutter_portfolio/util/cache/cache_controlling.dart';
import 'package:my_flutter_portfolio/util/env/flavor_config.dart';
import 'package:icapps_architecture/icapps_architecture.dart';

class MFPNetworkImage extends StatelessWidget {
  final String? url;
...
class _MFPBetterNetworkImage extends StatefulWidget {
  ...
  @override
  _MFPBetterNetworkImageState createState() => _MFPBetterNetworkImageState();
}

class _MFPBetterNetworkImageState extends State<_MFPBetterNetworkImage> {
  ...
  @override
  void didUpdateWidget(_MFPBetterNetworkImage oldWidget) {
